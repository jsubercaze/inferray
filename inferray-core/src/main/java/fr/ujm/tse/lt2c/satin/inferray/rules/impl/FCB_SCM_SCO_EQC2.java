 ...
 *
 */
public class FCB_SCM_SCO_EQC2 extends ClassBetaRule {

	public FCB_SCM_SCO_EQC2(final NodeDictionary dictionary,
		...
		super(dictionary, tripleStore, usableTriples, outputTriples,
				(int) NodeDictionary.rdfssubClassOf,
				(int) NodeDictionary.owlequivalentClass, true, "SCM_SCO_EQC2",true);
	}

...
public class FCZ_RDFS13 extends ClassZetaRule {

	public FCZ_RDFS13(final NodeDictionary dictionary, final CacheTripleStore tripleStore,
		...
		super(dictionary, tripleStore, usableTriples, outputTriples,
				AbstractDictionary.rdfsDatatype, AbstractDictionary.rdfssubClassOf, -1, "RDFS13");

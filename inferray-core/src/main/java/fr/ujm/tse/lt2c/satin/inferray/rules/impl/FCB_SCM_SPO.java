 ...
 *
 */
public class FCB_SCM_SPO extends ClassBetaRule {

	public FCB_SCM_SPO(final NodeDictionary dictionary, final CacheTripleStore tripleStore,
		...
		super(dictionary, tripleStore, usableTriples, outputTriples,
				...
				(int) NodeDictionary.owlequivalentProperty, false,
				"SCM_SPO_EQP2");
	}

 ...
 *
 */
public class FCA_CAX_EQC1 extends ClassAlphaRule {

	public FCA_CAX_EQC1(final NodeDictionary dictionary, final CacheTripleStore tripleStore,
		...
		super(dictionary, tripleStore, usableTriples, outputTriples,
				(int) NodeDictionary.owlequivalentClass, (int) NodeDictionary.rdftype,
				3, 4, 2, "CAX-EQC1");
	}

 ...
 *
 */
public class FCE_PRP_EQP_1_2 extends ClassEpsilonRule {

	public FCE_PRP_EQP_1_2(final NodeDictionary dictionary,
		...
		super(dictionary, tripleStore, usableTriples, outputTriples,
				(int) NodeDictionary.owlequivalentProperty, false, "PRP_EQP_1_2");
	}

...
public class TestTripleStoreMerging7 {

	@Test
	public void test() {

		final int p = 10;
		final long[] mainTriples = { 0, 0, 2, 1 };
		final long[] outputTriples = { 1, 0, 2, 1, 3, 5 };
		final long[] expectedNew = { 1, 0, 3, 5 };
		final long[] expectedmain = { 0, 0, 1, 0, 2, 1, 3, 5 };

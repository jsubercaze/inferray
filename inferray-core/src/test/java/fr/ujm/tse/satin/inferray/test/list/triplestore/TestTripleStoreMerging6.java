...
public class TestTripleStoreMerging6 {

	@Test
	public void test() {

		final int p = 10;
		final long[] mainTriples = { 2, 1, 3, 5, 4, 7, 10, 8 };
		final long[] outputTriples = { 5, 1, 6, 5, 6, 8, 9, 7 };
		final long[] expectedNew = { 5, 1, 6, 5, 6, 8, 9, 7 };
		final long[] expectedmain = { 2, 1, 3, 5, 4, 7, 5, 1, 6, 5, 6, 8, 9, 7, 10, 8 };
